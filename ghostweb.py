...
if __name__=="__main__":
    ...
    print("GhostWeb Web Vulnerability Scanner")
    ...
    with open(args.output, 'w') as f:
        ...
        f.write('SQL Report: ' + str(scan_sql_injection(args.url)))
        f.write('\n\n')
        f.write('XSS Report: ' + str(scan_xss(args.url)))
        f.write('\n\n')
        f.write('RCE Report: ' + str(remote_code_execution(args.url)))
        f.write('\n\n')
        f.write('Security Misconfiguration Report: ' + str(security_misconfiguration(args.url)))
        f.write('\n\n')
        f.write('Broken OAuth Report: ' + str(broken_auth(args.url)))
        f.write('\n\n')
        f.write('CSRF Report: ' + str(csrf_scan(args.url)))
        f.write('\n\n')
